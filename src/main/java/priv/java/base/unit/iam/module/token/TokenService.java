...
public interface TokenService {
	 ...
	 * @return SaSession
	 */
	public default Session getSession(String sessionId) {
		return (Session)getObject(sessionId);
	}
	 ...
	 * @param timeout 过期时间 (单位: 秒)
	 */
	public default void setSession(Session session, long timeout) {
	 ...
	 */
	public default void updateSession(Session session) {

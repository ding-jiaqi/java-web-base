...
public class TokenConfigFactory {
	...
	private static Map<String, String> readPropToMap(String propertiesPath) {
		...
		try {
			InputStream is = TokenConfigFactory.class.getClassLoader().getResourceAsStream(propertiesPath);
			if (is == null) {
				return null;
			}

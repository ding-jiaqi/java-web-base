...
public class Session implements Serializable {
	 ...
	 * @return 对象自身
	 */
	public Session setCreateTime(long createTime) {
	 ...
	 */
	public void update() {
		IAMComponentFactory.getSaTokenDao().updateSession(this);
	}

	/** 注销会话 (注销后，此session会话将不再存储服务器上) */
	public void logout() {
		IAMComponentFactory.getSaTokenDao().deleteSession(this.id);
	}
